...
- ✅ **Full QA Sweep (Mode B)** — All 10 core flows tested and passing on live site
  ...
  - Analysis (from imported PGN — move list, eval +0.0, best move d4, engine selector, transport controls, "C84 Ruy Lopez: Closed" detected) ✅
...
- UX: Invalid move gives no feedback — confirmed still present 2026-05-17
- UX: "Report Issue" link points to "#" — confirmed still present 2026-05-17
