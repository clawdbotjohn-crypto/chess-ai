...
- [ ] **UX: "Report Issue" link points to "#"** — ⚠️ QA STILL BROKEN 2026-06-12. Settings → About → "Report Issue" link has href="#". GitHub and Documentation links work correctly but Report Issue is still a placeholder.
- [x] **Date format consistency** — ✅ PASS. History page shows "Just now" (relative) and "Jun 12, 6:07 AM" (US format). No DD/MM/YYYY European format observed.
- [x] **User walkthrough** — ✅ PASS. All core flows functional — game play, AI response ~1.5s, opening detection (Scandinavian Defense), move history, navigation, Settings, Position Setup, AI Personality Editor, Bot Arena. Polished dark UI. No new issues found.

### QA Findings — 2026-06-11
- [ ] **BUG: Resign button non-functional** — ⚠️ QA STILL BROKEN 2026-06-11. Started game vs AI, played e4 (AI responded d5), played d4 (AI responded). Clicked Resign button (flag icon) — no confirmation dialog, no game-over state, still shows "Your turn." 5th day open.
- [ ] **UX: Invalid move gives no feedback** — ⚠️ QA STILL BROKEN 2026-06-11. Typed "Qx99" and clicked Submit — no error message, no toast, no visual feedback. Input silently cleared. User has no idea why move didn't work.
- [ ] **UX: "Report Issue" link points to "#"** — ⚠️ QA STILL BROKEN 2026-06-11. Settings → About → "Report Issue" link has href="#". GitHub and Documentation links work correctly but Report Issue is still a placeholder.

### QA Findings — 2026-06-10
- [ ] **BUG: Resign button non-functional** — ⚠️ QA STILL BROKEN 2026-06-10. Started game (e4 d5 exd5 Qxd5), clicked Resign button — no confirmation dialog, no game end, still shows "Your turn." 4th day open.
- [ ] **UX: Invalid move gives no feedback** — ⚠️ QA STILL BROKEN 2026-06-10. Typed "Qx99", clicked Submit — no error toast, no visual indicator, nothing happens. User has no idea why move wasn't accepted.
- [ ] **UX: "Report Issue" link points to "#"** — ⚠️ QA STILL BROKEN 2026-06-10. Settings → About → "Report Issue" href is still "#". Should point to GitHub issues page.
- [x] **User walkthrough** — ✅ PASS. Core flows all functional — game play, trades computation, opening identification (Scandinavian Defense: Mieses-Kotroc Variation), text input, move history, navigation, Settings page.

### QA Findings — 2026-06-09
- [ ] **BUG: Resign button non-functional** — ⚠️ QA STILL BROKEN 2026-06-09. Started game, played 4 moves, clicked Resign (flag icon). No confirmation dialog, no game state change. 3rd day open.
- [x] **User walkthrough** — ✅ PASS. All core flows functional — game play, history, AI personality editor, arena, analysis, position setup, settings. Polished dark UI. Feature-rich and well-organized.

### QA Findings — 2026-06-07
- [ ] **BUG: Resign button non-functional** — During a Human vs AI game with 4 moves played (e4 d5 Nf3 Nf6), clicking the Resign button (flag icon) repeatedly has zero effect. No confirmation prompt appears, no game end state, the game stays at "Your turn." Players cannot resign games. ⚠️ QA STILL BROKEN 2026-06-08
- [x] **User walkthrough** — ✅ PASS. Home page well-organized, game starts smoothly, AI responds in ~1.7s at depth 4, opening identification works (Scandinavian Defense, Zukertort Opening). AI Personality Editor, Bot Arena, Position Setup, Online Play, and Settings all load and function. Dark theme polished.
...
- [ ] **UX: Invalid move gives no feedback** — Typing an invalid algebraic move (e.g., "Qx99") and clicking Submit does nothing. No error toast, no visual indicator. User has no idea why their move wasn't accepted. ⚠️ QA STILL BROKEN 2026-05-14 ⚠️ QA STILL BROKEN 2026-05-15 ⚠️ QA STILL BROKEN 2026-05-16 ⚠️ QA STILL BROKEN 2026-05-17 ⚠️ QA STILL BROKEN 2026-05-19 ⚠️ QA STILL BROKEN 2026-05-20 ⚠️ QA STILL BROKEN 2026-05-22 ⚠️ QA STILL BROKEN 2026-05-29 ⚠️ QA STILL BROKEN 2026-06-01 ⚠️ QA STILL BROKEN 2026-06-02 ⚠️ QA STILL BROKEN 2026-06-07 ⚠️ QA STILL BROKEN 2026-06-08 ⚠️ QA STILL BROKEN 2026-06-09 ⚠️ QA STILL BROKEN 2026-06-10 ⚠️ QA STILL BROKEN 2026-06-12
...
- [ ] **UX: "Report Issue" link points to "#"** — In Settings → About section, the "Report Issue" link href is just `"#"` — should point to the GitHub issues page. ⚠️ QA STILL BROKEN 2026-05-14 ⚠️ QA STILL BROKEN 2026-05-15 ⚠️ QA STILL BROKEN 2026-05-16 ⚠️ QA STILL BROKEN 2026-05-17 ⚠️ QA STILL BROKEN 2026-05-19 ⚠️ QA STILL BROKEN 2026-05-20 ⚠️ QA STILL BROKEN 2026-05-22 ⚠️ QA STILL BROKEN 2026-05-29 ⚠️ QA STILL BROKEN 2026-06-01 ⚠️ QA STILL BROKEN 2026-06-02 ⚠️ QA STILL BROKEN 2026-06-07 ⚠️ QA STILL BROKEN 2026-06-08 ⚠️ QA STILL BROKEN 2026-06-09 ⚠️ QA STILL BROKEN 2026-06-10 ⚠️ QA STILL BROKEN 2026-06-12
