...
- [x] **UX: Analysis result text contradiction** — After importing a PGN with result "1-0", the analysis footer shows "0-1 White wins" — the result code and text description conflict with each other. ⚠️ QA STILL BROKEN 2026-05-13 ✅ QA VERIFIED FIXED 2026-05-14
- [ ] **UX: Invalid move gives no feedback** — Typing an invalid algebraic move (e.g., "Qx99") and clicking Submit does nothing. No error toast, no visual indicator. User has no idea why their move wasn't accepted. ⚠️ QA STILL BROKEN 2026-05-14
...
- [ ] **UX: "Report Issue" link points to "#"** — In Settings → About section, the "Report Issue" link href is just `"#"` — should point to the GitHub issues page. ⚠️ QA STILL BROKEN 2026-05-14
